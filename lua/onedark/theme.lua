...
function M.setup()
	...
	theme.highlights = {
		...
		Search = { bg = c.BackDark, fg = c.Front }, -- Last search pattern highlighting (see 'hlsearch').  Also used for similar items that need to stand out.
		IncSearch = { bg = c.Yellow, fg = c.BackDark }, -- 'incsearch' highlighting; also used for the text replaced with ":s///c"
