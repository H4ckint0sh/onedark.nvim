...
theme.set_highlights = function(opts)
	...
	hl(0, "LineNr", { fg = c.onedarkPurple, bg = c.onedarkBack })
	hl(0, "CursorLineNr", { fg = c.onedarkGreen, bg = c.onedarkBack, bold = true })
	...
	hl(0, "PreProc", { fg = c.onedarkPink, bg = "NONE" })
	hl(0, "Include", { fg = c.onedarkBlue, bg = "NONE" })
	hl(0, "Define", { fg = c.onedarkPink, bg = "NONE" })
	hl(0, "Macro", { fg = c.onedarkPink, bg = "NONE" })
	hl(0, "Type", { fg = c.onedarkBlue, bg = "NONE" })
	hl(0, "StorageClass", { fg = c.onedarkBlue, bg = "NONE" })
	hl(0, "Structure", { fg = c.onedarkBlue, bg = "NONE" })
	hl(0, "Typedef", { fg = c.onedarkBlue, bg = "NONE" })
	...
	hl(0, "Whitespace", { fg = isDark and c.onedarkPurple or c.onedarkTabOther })

	-- Treesitter
	hl(0, "TSError", { fg = c.onedarkRed, bg = "NONE" })
	hl(0, "TSPunctBracket", { fg = c.onedarkLightBlue, bg = "NONE" })
	hl(0, "TSPunctSpecial", { fg = c.onedarkLightBlue, bg = "NONE" })
	...
	hl(0, "TSConstant", { fg = c.onedarkGreen, bg = "NONE" })
	hl(0, "TSConstBuiltin", { fg = c.onedarkBlue, bg = "NONE" })
	hl(0, "TSConstMacro", { fg = c.onedarkBlueGreen, bg = "NONE" })
	hl(0, "TSStringRegex", { fg = c.onedarkGreen, bg = "NONE" })
	...
	hl(0, "TSField", { fg = c.onedarkLightBlue, bg = "NONE" })
	hl(0, "TSProperty", { fg = c.onedarkFront, bg = "NONE" })
	hl(0, "TSConstructor", { fg = c.onedarkRed, bg = "NONE" })
	hl(0, "TSConditional", { fg = c.onedarkLightBlue, bg = "NONE" })
	hl(0, "TSRepeat", { fg = c.onedarkPink, bg = "NONE" })
	hl(0, "TSLabel", { fg = c.onedarkLightBlue, bg = "NONE" })
	hl(0, "TSKeyword", { fg = c.onedarkPurple, bg = "NONE" })
	hl(0, "TSKeywordFunction", { fg = c.onedarkPurple, bg = "NONE" })
	hl(0, "TSKeywordOperator", { fg = c.onedarkBlue, bg = "NONE" })
	hl(0, "TSKeywordReturn", { fg = c.onedarkLightBlue, bg = "NONE" })
	hl(0, "TSOperator", { fg = c.onedarkLightBlue, bg = "NONE" })
	hl(0, "TSException", { fg = c.onedarkPink, bg = "NONE" })
	hl(0, "TSType", { fg = c.onedarkGreen, bg = "NONE" })
	hl(0, "TSTypeBuiltin", { fg = c.onedarkPurple, bg = "NONE" })
	...
	hl(0, "TSTagDelimiter", { fg = c.onedarkLightBlue, bg = "NONE" })
	hl(0, "TSNone", { fg = c.onedarkFront, bg = "NONE" })
	hl(0, "TSTagAttribute", { fg = c.onedarkYellow, bg = "NONE" })
	...
	hl(0, "TSPunctDelimiter", { fg = c.onedarkLightBlue, bg = "NONE" })
	...
	hl(0, "typescriptLogicSymbols", { fg = c.onedarkLightBlue, bg = "NONE" })
	...
	hl(0, "typescriptTypeReference", { fg = c.onedarkBlueGreen, bg = "NONE" })
	...
	hl(0, "typescriptPredefinedType", { fg = c.onedarkBlueGreen, bg = "NONE" })
	...
	hl(0, "typescriptTypeParameter", { fg = c.onedarkBlueGreen, bg = "NONE" })
	...
	hl(0, "typescriptFuncTypeArrow", { fg = c.onedarkBlue, bg = "NONE" })
	...
	if isDark then
		...
		hl(0, "NvimTreeIndentMarker", { fg = c.onedarkPurple, bg = "NONE" })

		hl(0, "LspFloatWinNormal", { fg = c.onedarkFront, bg = "NONE" })
		hl(0, "LspFloatWinBorder", { fg = c.onedarkPurple, bg = "NONE" })
		...
		hl(0, "TelescopePromptBorder", { fg = c.onedarkPurple, bg = "NONE" })
		hl(0, "TelescopeResultsBorder", { fg = c.onedarkPurple, bg = "NONE" })
		hl(0, "TelescopePreviewBorder", { fg = c.onedarkPurple, bg = "NONE" })
