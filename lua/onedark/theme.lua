...
theme.set_highlights = function(opts)
	...
	hl(0, "LineNr", { fg = c.onedarkLineNumber, bg = c.onedarkBack })
	...
	hl(0, "Comment", { fg = c.onedarkDisabled, bg = "NONE", italic = opts.italic_comments })
	...
	hl(0, "Whitespace", { fg = isDark and c.onedarkLineNumber or c.onedarkTabOther })
	...
	hl(0, "TSInclude", { fg = c.onedarkPurple, bg = "NONE", fmt = "italic" })
