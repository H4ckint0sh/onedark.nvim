...
theme.set_highlights = function(opts)
	...
	hl(0, "DiffChange", { fg = "NONE", bg = c.onedarkDiffRedLightLight })
	hl(0, "DiffDelete", { fg = "NONE", bg = c.onedarkDiffRedLightLight })
	hl(0, "DiffText", { fg = "NONE", bg = c.onedarkDiffRedLightLight })
	...
	if isDark then
		...
		hl(0, "NvimTreeCursorLine", { fg = "NONE", bg = c.onedarkDisabled })
