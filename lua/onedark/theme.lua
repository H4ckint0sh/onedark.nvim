...
theme.set_highlights = function(opts)
	...
	hl(0, "Pmenu", { fg = c.onedarkFront, bg = "NONE" })
	hl(0, "PmenuSel", { fg = c.onedarkPurple, bg = c.onedarkPopupHighlightBlue })
	hl(0, "PmenuSbar", { fg = c.onedarkFront, bg = "NONE" })
	hl(0, "PmenuThumb", { fg = c.onedarkFront, bg = "NONE" })
